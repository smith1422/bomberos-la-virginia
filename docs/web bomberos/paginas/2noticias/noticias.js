...
/**
 * Evento scroll: al llegar al final de la página, se cargan más noticias.
 */
let cargando = false;
window.addEventListener("scroll", () => {
  ...
  if (scrollPosition >= nearBottom && !cargando) {
    cargando = true;

    // Simula un retardo como si cargara desde un servidor
    setTimeout(() => {
